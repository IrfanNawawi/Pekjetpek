...
class MovieTvShowRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(
            ...
            instance ?: synchronized(this) {
                instance ?: MovieTvShowRepository(remoteDataSource, localData, appExecutors)
            }
    }
    ...
    override fun getMovieDetail(movieId: Int): LiveData<Resource<MovieEntity>> {
        return object :
            NetworkBoundResource<MovieEntity, MovieItem>(
                appExecutors
            ) {
    ...
    override fun getAllTvShows(sort: String): LiveData<Resource<PagedList<TvShowEntity>>> {
        return object :
            NetworkBoundResource<PagedList<TvShowEntity>, List<TvShowItem>>(
                appExecutors
            ) {
